...
import com.anchor.train.member.domain.Ticket;
import com.anchor.train.member.domain.TicketExample;
import com.anchor.train.member.mapper.TicketMapper;
...
public class TicketService {
    ...
    public PageResp
            <TicketQueryResp> queryList(TicketQueryReq req) {
        ...
        List
                <TicketQueryResp> list = BeanUtil.copyToList(ticketList, TicketQueryResp.class);

        PageResp
                <TicketQueryResp> pageResp = new PageResp<>();
