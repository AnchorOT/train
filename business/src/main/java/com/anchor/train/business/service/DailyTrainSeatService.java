...
import com.anchor.train.business.domain.DailyTrainSeatExample;
import com.anchor.train.business.domain.TrainSeat;
import com.anchor.train.business.domain.TrainStation;
import com.anchor.train.business.mapper.DailyTrainSeatMapper;
import com.anchor.train.business.req.DailyTrainSeatQueryReq;
import com.anchor.train.business.req.DailyTrainSeatSaveReq;
import com.anchor.train.business.resp.DailyTrainSeatQueryResp;
...
public class DailyTrainSeatService {
    ...
    public PageResp
            <DailyTrainSeatQueryResp> queryList(DailyTrainSeatQueryReq req) {
        ...
        List
                <DailyTrainSeatQueryResp> list = BeanUtil.copyToList(dailyTrainSeatList, DailyTrainSeatQueryResp.class);

        PageResp
                <DailyTrainSeatQueryResp> pageResp = new PageResp<>();
