...
import com.anchor.train.business.domain.DailyTrainStation;
import com.anchor.train.business.domain.DailyTrainStationExample;
import com.anchor.train.business.domain.TrainStation;
import com.anchor.train.business.mapper.DailyTrainStationMapper;
...
public class DailyTrainStationService {
    ...
    public PageResp
            <DailyTrainStationQueryResp> queryList(DailyTrainStationQueryReq req) {
        ...
        List
                <DailyTrainStationQueryResp> list = BeanUtil.copyToList(dailyTrainStationList, DailyTrainStationQueryResp.class);

        PageResp
                <DailyTrainStationQueryResp> pageResp = new PageResp<>();
