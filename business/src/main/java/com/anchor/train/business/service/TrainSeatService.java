...
import com.anchor.train.business.domain.TrainSeatExample;
import com.anchor.train.business.enums.SeatColEnum;
import com.anchor.train.business.mapper.TrainSeatMapper;
...
public class TrainSeatService {
    ...
    public PageResp
        ...
        List
                <TrainSeatQueryResp> list = BeanUtil.copyToList(trainSeatList, TrainSeatQueryResp.class);

        PageResp
                <TrainSeatQueryResp> pageResp = new PageResp<>();
